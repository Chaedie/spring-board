                    ...
                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                      ...
                      <form id="joinForm" class="mx-1 mx-md-4" method="post" action="join">
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                          ...
                          <div class="form-outline flex-fill mb-0">
                            <input id="userEmail" name="userEmail" type="email" id="form3Example3c" class="form-control"
                                   value="<%=userEmail%>"/>
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                          ...
                          <div class="form-outline flex-fill mb-0">
                            <div class="d-flex gap-4">
                              <input type="text" name="authCode" class="form-control" placeholder="인증 코드를 입력해주세요!">
                              <label class="form-label" for="form3Example3c">timer</label>
